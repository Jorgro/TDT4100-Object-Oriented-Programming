...
public class ExamRequirement {
    ...
    /**
     * Returns true if the provided Exam is for the specified course, not before the
     * specified year and not worse than the specified grade.
     * 
     * @param exam
     * @return
     */
    public boolean accepts(Exam exam) {
        return acceptsCourse(exam.getCourse()) && exam.getGrade().value >= 1;
    }

    // declares atLeastCInTdt4100

    public final static ExamRequirement atLeastCInTdt4100 = new ExamRequirement("TDT4100", 2010, 'C');
     =  c -> 
